...
ShowTile.prototype.setState = function (ste){
    ...
    switch (self.state){
        ...
        case ShowTile.STATE_SELECTED:
            ...
            {
                self.colorFrame.graphics.drawRect(5,"#0cd248",[3,3,self.rect.width - 6,self.rect.height - 6],false);
                self.isRight = true;
            }
            else{
                self.colorFrame.graphics.drawRect(5,"#d23e21",[3,3,self.rect.width - 6,self.rect.height - 6],false);
                self.isRight = false;
            }
            break;
    }
